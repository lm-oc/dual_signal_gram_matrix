...
from network.ressl_third import ReSSL
import time
import os
...
def train(train_loader, model, optimizer, epoch, iteration_per_epoch, base_lr):
    ...
    progress = ProgressMeter(
        len(train_loader),
        [batch_time, data_time, ce_losses, losses3],
    ...
    for i, (img1, img2, img3) in enumerate(train_loader):
        ...
        loss2, loss3 = model(img1, img2, img3)
...
def main():
    ...
    checkpoint_path = 'checkpoints/ressl-16-third-{}.pth'.format(args.dataset)
